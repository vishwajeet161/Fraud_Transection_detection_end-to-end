...
from Training_DataType_Validation.DataType_Validation import DBOperations
...
class Train_Validation:
    ...
    def training_validation(self):
        try:
            ...
            self.DbOperation.createTable_AdditionalFile('Training',additionalFile_ColName)
            ...
            self.DbOperation.SelectingDataFromTableIntoCSV_AdditionalFile('Training')
